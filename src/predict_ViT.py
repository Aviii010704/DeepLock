...
from model import get_vit  # Import ViT model

# ✅ Define paths
MODEL_PATH = r"../models/deeplock_ViT.pth"
...
model = get_vit(pretrained=False).to(device)  # No need for pretrained weights
...
if __name__ == "__main__":
    test_image = r"C:\Users\Aviral\Desktop\Aviral_Photo.jpg"  # Change to the image path you want to test
